...
export function OpinionsContextProvider({ children }) {
  ...
  useEffect(() => {
    async function loadOpinions() {
      const response = await fetch('https://opinion-blog.onrender.com/opinions');
  ...
  async function upvoteOpinion(id) {
    const response = await fetch('https://opinion-blog.onrender.com/opinions/' + id + '/upvote',
      {
        method: 'POST',
      }
    );
  ...
  async function downvoteOpinion(id) {
    ...
    const response = await fetch('https://opinion-blog.onrender.com/opinions/' + id + '/downvote',
      {
        method: 'POST'
      }
    );
